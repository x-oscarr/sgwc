...
var colorPickerWrappers = document.querySelectorAll('.color-picker');
  ...
  wrapper.addEventListener('click', function (event) {
    ...
    if (!picker) {
      ...
      picker.onChange = function (color) {
        ...
        wrapper.style.boxShadow = "0 0 10px rgba(" + color.rgba[0] + ", " + color.rgba[1] + ", " + color.rgba[2] + ", 0.5)"; // Preview block
        // Background
...
for (var _i = 0, _arr = _toConsumableArray(colorPickerWrappers); _i < _arr.length; _i++) {
  _loop();
}
